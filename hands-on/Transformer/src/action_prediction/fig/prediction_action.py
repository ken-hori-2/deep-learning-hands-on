...
def evaluate(flag, model, data_provider, criterion):
    ...
    if flag=='test':
        ...
        plt.savefig('prediction_action.png')
...
if __name__ == "__main__":
    ...
    # テスト用データにおける予測
    result = evaluate(flag='test', model=best_model, data_provider=data_provider('test', src_len, tgt_len, batch_size), criterion=criterion)
    print(result)
    # 0.5851381
