...
# plt.plot(total_data.index, total_data['actions'])

plt.plot(total_data['date'], total_data['actions'])
# plt.plot(df_sort.index, total_data['actions'])
# plt.yticks(total_data['actions'], df_sort['actions'])
...
print(total_data)
plt.plot(total_data['date'], pre['actions']) # total_data['actions'])
plt.show()